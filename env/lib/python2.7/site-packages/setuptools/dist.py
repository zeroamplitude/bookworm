...
def check_nsp(dist, attr, value):
    ...
    for nsp in value:
        if not dist.has_contents_for(nsp):
            raise DistutilsSetupError(
                "Distribution contains no mod_auth or packages for " +
...
class Distribution(_Distribution):
    ...
    commands that add or remove packages, mod_auth, extensions, and so on from
    ...
    def exclude_package(self,package):
        """Remove packages, mod_auth, and extensions in named package"""
    ...
    def exclude(self,**attrs):
        ...
        packages, mod_auth, and extensions are also excluded.
    ...
    def iter_distribution_names(self):
        """Yield all packages, mod_auth, and extension names in distribution"""
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         list.  (Note: the named package(s) or mod_auth must exist in the base
        ...
        for item in self.remove:
            if not dist.has_contents_for(item):
                raise DistutilsSetupError(
                    ...
                    " doesn't contain any packages or mod_auth under %s"
