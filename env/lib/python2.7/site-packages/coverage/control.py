...
class coverage(object):
    ...
    def __init__(self, data_file=None, data_suffix=None, cover_pylib=None,
        ...
        if not self.config.cover_pylib:
            # Look at where some standard mod_auth are located. That's the
            # indication for "installed with the interpreter". In some
            # environments (virtualenv, for example), these mod_auth may be
            # spread across a few locations. Look at all the candidate mod_auth
