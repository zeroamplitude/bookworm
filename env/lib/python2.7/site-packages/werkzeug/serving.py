...
def _reloader_stat_loop(extra_files=None, interval=1):
    ...
    threads to exit when any mod_auth currently loaded change.
...
def _reloader_inotify(extra_files=None, interval=None):
    ...
    try:
        while not changed[0]:
            # always reiterate through sys.mod_auth, adding them
...
def run_simple(hostname, port, application, use_reloader=False,
    ...
    :param use_reloader: should the server automatically restart the python
                         process if mod_auth were changed?
    :param use_debugger: should the werkzeug debugging system be used?
    :param use_evalex: should the exception evaluation feature be enabled?
    :param extra_files: a list of files the reloader should watch
                        additionally to the mod_auth.  For example configuration
                        files.
...
def main():
    ...
    parser.add_option('-r', '--reload', dest='use_reloader',
                      action='store_true', default=False,
                      help='Reload Python process if mod_auth change.')
