...
"""
    ...
    API in a env application easier.  Adapt this code for your own
...
AX_MAPPING = {
    ...
    'postcode':     ['http://axschema.org/contact/postalCode/home.html',
                     'http://schema.openid.net/contact/postalCode/home.html'],
    'country':      ['http://axschema.org/contact/country/home.html',
                     'http://schema.openid.net/contact/country/home.html'],
...
class OpenID(object):
    ...
    def _default_store_factory(self):
        ...
        if path is None:
            path = os.path.join(tempfile.gettempdir(), 'env-openid')
